...
<body>
        <form method="post" action="q_write_ok.php" enctype="multipart/form-data" autocomplete="off">
                ...
                <td>
                    <table class="table2">
                        <tr>
                            ...
                            <td ><input type="text" class="t_box" name="name" style="font-size: 15px;" cols=20 size=15 required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td ><input type="text" class="t_box" name="email" style="font-size: 15px;" cols=25 size=40 required></td>
                        </tr>
                        <tr>
