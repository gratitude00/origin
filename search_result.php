   ...
   <p class="hh"><b>Board</b></p>
    <div style="text-align: center; margin-bottom: 30px; font-size: 30px">
      <form action="search_result.php" method="get">
        ...
        <input type="text" class="search_bo" name="search" id="search_box" size="30" style="margin-left: 10px; margin-right: 10px;" autocomplete="off" />
    ...
    <table align=center>
        ...
        if(!$search_result = mysqli_num_rows($result)) {?>
        	<tbody>
        		<tr style="color: red; background: #ffffff; font-size:20px; font-weight: bold;" align="center">
        			<td> x </td>
        			<td width="500">x</td>
        			<td width="100">x</td>
        			<td width="200">x</td>
